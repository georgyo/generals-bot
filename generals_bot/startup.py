...
def startup(moveMethod, moveEvent=None, botName="PurdueBot"):
    ...
    parser.add_argument(
        ...
        default=os.environ.get("GENERALS_BOT_MODE", "private"),
    ...
    parser.add_argument(
        ...
        metavar="str",
        type=str,
        default=os.environ.get("GENERALS_BOT_ROOM_ID", "PurdueBot"),
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Initial Setup Command (optional)",
    )
    parser.add_argument(
